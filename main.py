...
SCAM_KEYWORDS = {
    ...
    "ACCOUNT_THREAT": [
        ...
        "account deactivated", "account restricted", "account compromised"
    ],
    "SECURITY_ALERT": [
...
{{
  "scamConfidenceScore": 0.95,
  "riskLevel": "CRITICAL",
  "intentSignals": ["CREDENTIAL_HARVESTING", "URGENCY_MANIPULATION"],
  "honeypotIntelligence": {{
    "scammerTactics": ["Impersonation", "Urgency", "Fear"],
    "recommendedResponse": "Deflect with confusion"
  }}
}}
